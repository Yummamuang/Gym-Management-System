<div class="absolute menubar_wrap lg:hidden">
    <div class="fixed flex items-center justify-between gap-4 px-16 cursor-pointer menu_bar">
        <div class="grid gap-1 menu_items place-items-center">
            @if (Route::currentRouteName() == 'dashboard.Trainers')
                <i class="block text-xl fa-sharp fa-house f_red"></i>
                <p class="block text-center f_red">หน้าหลัก</p>
            @else
                <a href="{{ route('dashboard.Trainers') }}" class="grid w-full gap-1 place-items-center">
        ...
        <div class="grid gap-1 menu_items place-items-center">
            @if (Route::currentRouteName() == 'course.Trainers')
                <i class="block text-xl fa-sharp fa-book-bookmark f_red"></i>
                <p class="block text-center f_red">คอร์สเรียน</p>
            @else
                <a href="{{ route('course.Trainers') }}" class="grid w-full gap-1 place-items-center">
        ...
        <div class="grid gap-1 menu_items place-items-center">
            @if (Route::currentRouteName() == 'checkin.Trainers')
                <i class="block text-xl fa-sharp fa-clock-rotate-left f_red"></i>
                <p class="block text-center f_red">ประวัติการเข้ายิม</p>
            @else
                <a href="{{ route('checkin.Trainers') }}" class="grid w-full gap-1 place-items-center">
        ...
        <div class="grid gap-1 menu_items place-items-center">
            @if (Route::currentRouteName() == 'card.Trainers')
                <i class="block text-xl fa-sharp fa-address-card f_red"></i>
                <p class="block text-center f_red">สมาชิกการ์ด</p>
            @else
                <a href="{{ route('card.Trainers') }}" class="grid w-full gap-1 place-items-center">
...
<div class="absolute hidden menubar_wrap_lg lg:block">
    <div class="fixed p-4 menu_bar_lg" id="menu_bar_lg">
        <div class="flex items-center justify-start gap-2 pt-4">
            ...
            @else
                <a href="{{ route('dashboard.Trainers') }}" class="flex items-center justify-center gap-2 menu_items_lg">
        ...
        <div class="flex items-center justify-start gap-2 py-2">
            ...
            @else
                <a href="{{ route('course.Trainers') }}" class="flex items-center justify-center gap-2 menu_items_lg">
        ...
        <div class="flex items-center justify-start gap-2 py-2">
            ...
            @else
                <a href="{{ route('checkin.Trainers') }}" class="flex items-center justify-center gap-2 menu_items_lg">
        ...
        <div class="flex items-center justify-start gap-2 py-2">
            ...
            @else
                <a href="{{ route('card.Trainers') }}" class="flex items-center justify-center gap-2 menu_items_lg">
