                ...
                <div class="grid grid-cols-3 mb-8" id="courses_box">
                    ...
                    <div class="relative col-span-2">
                        ...
                        <div class="absolute bottom-0 right-0 px-5 py-3 mb-4 mr-6 text-white rounded-full regis_course">
                            <a href="{{ route('addcourse.Trainers', ['trainerid' => $trainers->trainerid, 'courseid' => $course->courseid]) }}">ลงสอนคอร์ส</a>
                        </div>
                    </div>
                </div>
            @endforeach
            ...
            @foreach ($courses as $course)
                ...
                <div class="grid grid-cols-3 mb-8" id="courses_box">
                    ...
                    <div class="relative col-span-2">
                        ...
                        <div class="mx-6 mt-2 text-xl f_gray">
                            @if ($course -> end_course == null)
                                <p class="f_red">ไม่มีวันกำหนดสอน</p>
                            @else
                                เริ่มสอนวันที่ {{ $course -> start_course }}
                            @endif
                        </div>
                        <div class="mx-6 mt-2 text-xl font-medium f_gray">
                            @if ($course -> end_course != null)
                                สอนถึงวันที่ {{ $course -> end_course }}
                            @endif
                        </div>
