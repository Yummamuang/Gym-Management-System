...
@section('content')
    ...
    <div class="flex flex-col items-center justify-center pt-10 mb-20 lg:pl-48">
        <div class="w-3/4 mt-2 flex_items md:mt-6 display_content" style="max-width: 900px">
            ...
            <form method="POST" action="{{ route('editDietPlanPost.Admin',  $diets -> dietid) }}" class="">
                @csrf
                <div class="grid grid-cols-2 xl:grid-cols-2 lg:gap-4">
                    ...
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 xl:mt-0" style="max-width: 450px">
                        <input id="diet_name" type="text" name="diet_name" placeholder=" " value="{{ $diets -> diet_name }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
                        <label for="diet_name" class="absolute block pl-3 mx-auto pointer-events-none f_gray md:text-lg">ชื่อการไดเอท</label>
                    </div>

                    <!-- Diet Type -->
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 xl:mt-0" style="max-width: 450px">
                        <input id="diet_type" type="text" name="diet_type" placeholder=" " value="{{ $diets -> diet_types }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
