...
@section('content')
    ...
    <div class="mx-auto mt-10 flex_items text-end logout_wrap">
        <a href="{{ route('logout.Trainers') }}" class="p-2 px-4 ml-auto lg:text-xl logout rounded-xl lg:p-3 lg:px-10">
            Logout
        </a>
    </div>
    ...
    <div class="flex flex-col items-center justify-center pt-10 mb-20">
        ...
        <div class="w-3/4 mt-2 flex_items md:mt-6 display_content" style="max-width: 750px">
            ...
            <form method="POST" action="{{ route('profileUpdatePicture.Trainers') }}" class="mb-4" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-2 xl:grid-cols-2 lg:gap-4">
                    ...
                    <div class="relative w-full col-span-2 mx-auto mt-3 xl:mt-0" style="max-width: 750px">
                        ...
                        @else
                            <img src="{{ asset($trainers->image) }}" alt="" class="absolute block rounded-full profile_pic" >
                        @endif
            ...
            <form method="POST" action="{{ route('profileUpdate.Members') }}" class="">
                ...
                <div class="grid grid-cols-2 xl:grid-cols-2 lg:gap-4">
                    ...
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 xl:mt-0" style="max-width: 450px">
                        <input id="weight" type="number" name="weight" placeholder=" " value="{{ $trainers->weight }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
                    ...
                    <!-- Height -->
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 xl:mt-0" style="max-width: 450px">
                        <input id="height" type="number" name="height" placeholder=" " value="{{ $trainers->height }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
                    ...
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 phone xl:mt-0" style="max-width: 450px">
                        <input id="phone" type="tel" name="phone" placeholder=" " value="{{ $trainers->phone }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
                    ...
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 address xl:mt-0" style="max-width: 450px">
                        <input id="address" type="text" name="address" placeholder=" " value="{{ $trainers->address }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
                    ...
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 username xl:mt-0" style="max-width: 450px">
                        <input id="username" type="text" name="username" placeholder=" " value="{{ $trainers->username }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
                    ...
                    <div class="relative w-full col-span-2 mx-auto mt-3 lg:col-span-1 email xl:mt-0" style="max-width: 450px">
                        <input id="email" type="email" name="email" placeholder=" " value="{{ $trainers->email }}" class="block w-full h-full px-4 pt-6 pb-2 mx-auto text-sm rounded-xl sm:rounded-2xl sm:px-5 sm:text-sm md:px-6 md:text-base md:pt-7 md:pb-4 lg:text-base f_gray "/>
